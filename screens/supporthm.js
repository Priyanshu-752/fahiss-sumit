...
const styles = StyleSheet.create({
  container: { flex: 1,
     backgroundColor: '#F9FAFB', paddingBottom: 80 
    },
  ...
  iconBox: { backgroundColor: '#FFFFFF', padding: 16,
     borderRadius: 16,
      elevation: 3 
    },
  iconText: { 
  ...
  footer: { 
    position: 'absolute',
     ...
     left: 0, 
    right: 0,
     flexDirection: 'row', justifyContent: 'space-around', paddingVertical: 16, backgroundColor: '#B1C9EF' },
