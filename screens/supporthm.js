    ...
    <View style={styles.container}>
      ...
      <View style={styles.supportSection}>
        {[
          ...
          { label: 'Chat with us', icon: 'chatbubble-outline', onPress: () => {} }
        ].map((item, index) => (
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity style={styles.footerItem}>
          <View style={styles.footerIconBox}>
            <Ionicons name="headset-outline" size={28} color="#4682EF" />
...
const styles = StyleSheet.create({
  ...
  footer: { position: 'absolute', bottom: 0, left: 0, right: 0, flexDirection: 'row', justifyContent: 'space-around', paddingVertical: 16, backgroundColor: '#B1C9EF' },
  footerItem: { alignItems: 'center' },
  footerIconBox: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#FFFFFF', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20 },
